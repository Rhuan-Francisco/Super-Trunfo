...
def game():
  ...
  print('Quem ganhar 5 rodadas primeiro vence o jogo.\n')
  ...
  while not game_over:
        ...
        try:
          ...
          if escolha == 1:
            ...
            if carta_usuario["atributos"]["forca"] > carta_adversario["atributos"]["forca"]:
              ...
              acertos += 1
              print(f'\nParabêns!\nVocê ganhou até agora {acertos} rodada(s).\n')
              break

            elif carta_usuario["atributos"]["forca"] == carta_adversario["atributos"]["forca"]:
              print(f'A força da {carta_usuario["nome"]} e a {carta_adversario["nome"]}, como foi empate, ninguem pontua e será escolhida outra carta para você.\n')
              break

            else:
              print(f"{carta_adversario['nome']} é mais forte que {carta_usuario['nome']}.")
              acertos_adversario += 1
              print(f'\nQue pena, você perdeu. \nSeu adversario ganhou até agora {acertos_adversario} rodada(s).\n')
              break
          ...
          # Comparando a velocidade dos dois animais
            ...
            if carta_usuario["atributos"]["velocidade"] > carta_adversario["atributos"]["velocidade"]:
              ...
              print(f'A velocidade da {carta_usuario["nome"]} e a {carta_adversario["nome"]}, como foi empate, ninguem pontua e será escolhida outra carta para você.\n')
              break
          ...
          # Comparando a inteligencia dos dois animais
            ...
            if carta_usuario["atributos"]["inteligencia"] > carta_adversario["atributos"]["inteligencia"]:
              ...
              print(f'A inteligencia da {carta_usuario["nome"]} e a {carta_adversario["nome"]}, como foi empate, ninguem pontua e será escolhida outra carta para você.\n')
              break
      ...
      elif acertos_adversario >= 5:
        print('Não foi dessa vez, boa sorte na proxima.')
        game_over = True
